    ...
    def create_inbound_route(
        ...
        async def freeswitch_route(freeswitch_config: FreeSwitchConfig, request: Request):
            ...
            freeswitch_client = FreeSwitchClient(
                ...
                record_calls=freeswitch_config.record,
            )
            return freeswitch_client.create_call_socket_instructions(
                conversation_id=conversation_id,
        ...
        if isinstance(inbound_call_config, TwilioInboundCallConfig):
            ...
            logger.info(
                f"Set up inbound call FreeSWITCH at https://{self.base_url}{inbound_call_config.url}"
            )
